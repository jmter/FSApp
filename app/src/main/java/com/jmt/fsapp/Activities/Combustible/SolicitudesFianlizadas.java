...
import com.jmt.fsapp.Constructors.ConstructorFinalizadaSolicitud;
...
public class SolicitudesFianlizadas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solicitudes_fianlizadas);
        ...
        solicitudes = new ConstructorFinalizadaSolicitud(listadoSolicitudesRV, activity).loadSolicitudes(userE);
    }
